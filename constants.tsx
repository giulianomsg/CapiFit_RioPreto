...
export const ICONS = {
  ...
  logo: <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8 text-primary" viewBox="0 0 24 24" fill="currentColor"><path d="M19.5 9.5c-1.2 0-2.3.6-3 1.5h-1c-1.1 0-2-.9-2-2V7c0-2.2-1.8-4-4-4S5.5 4.8 5.5 7v2c0 1.1-.9 2-2 2h-1c-.8 0-1.5.7-1.5 1.5v1c0 .8.7 1.5 1.5 1.5h1c.5 0 1 .2 1.4.6.9 1 1.2 2.4.8 3.7-.4 1.3-1.6 2.2-3 2.2H2v1h2.2c2.1 0 4-1.5 4.6-3.5.6-2-1-4-2.8-4.1H5.5c-1.1 0-2-.9-2-2v-1c0-.6.4-1 1-1h1c1.7 0 3-1.3 3-3V7c0-1.7 1.3-3 3-3s3 1.3 3 3v2c0 1.7 1.3 3 3 3h1c.6 0 1 .4 1 1v1c0 .6-.4 1-1 1h-.5c-1.9 0-3.5 1.6-3.5 3.5v.5h1v-1.5c0-.6.4-1 1-1h1.5c1.4 0 2.5-1.1 2.5-2.5V11c0-1.4-1.1-2.5-2.5-2.5h-1zm-4.5 9c-.8 0-1.5-.7-1.5-1.5s.7-1.5 1.5-1.5 1.5.7 1.5 1.5-.7 1.5-1.5 1.5zm4 0c-.8 0-1.5-.7-1.5-1.5s.7-1.5 1.5-1.5 1.5.7 1.5 1.5-.7 1.5-1.5 1.5z"/></svg>,
